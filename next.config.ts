...
const csp = [
  "default-src 'self'",
  // Scripts: self + GA + Vercel Insights. 'unsafe-inline' nécessaire pour Next.js inline scripts (boot).
  ...
  "img-src 'self' data: blob: https://media.cabane135.fr https://*.public.blob.vercel-storage.com https://maps.gstatic.com https://maps.googleapis.com https://www.google.com https://www.google-analytics.com",
  // Connect: self + GA + Vercel analytics
